...
export function TextareaField({ field, onUpdate, onDelete }: TextareaFieldProps) {
  return (
    <div className="space-y-3 p-3 border rounded-lg bg-stone-50/30">
      <div className="flex items-center justify-between">
        <Label className="text-sm font-medium">Campo de Texto Longo</Label>
        <Button
          variant="ghost"
          size="sm"
      ...
      <div className="grid grid-cols-2 gap-3">
        <div>
          ...
          <Input
            ...
            placeholder="Ex: Descrição do Personagem"
          />
        </div>
