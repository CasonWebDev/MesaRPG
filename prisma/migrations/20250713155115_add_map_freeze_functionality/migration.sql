...
INSERT INTO "new_game_states" ("activeMapId", "campaignId", "fogAreas", "gameData", "gridConfig", "id", "lastActivity", "tokens", "updatedAt") SELECT "activeMapId", "campaignId", "fogAreas", "gameData", "gridConfig", "id", "lastActivity", "tokens", "updatedAt" FROM "game_states";
